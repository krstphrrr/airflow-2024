...
from custom_scripts.config import SCHEMAPLAN_PATH, PROJECTFILE_PATH
from custom_scripts.data_cleaner import deduplicate_dataframe, bitfix, dateloadedfix, create_postgis_geometry, numericfix, integerfix, add_or_update_project_key
from custom_scripts.utils import schema_to_dictionary, generate_unique_constraint_standalone
from custom_scripts.data_validator import dataframe_validator
from custom_scripts.db_connector import insert_project, subset_and_save, populate_datevisited
...
def process_csv(file_name: str, project_key: str = None):
    ...
    try:
        ...
        csv_df = pl.read_csv(f"data/{table_name}.csv", null_values=["NA", "N/A", "null"], infer_schema_length=1000000)
